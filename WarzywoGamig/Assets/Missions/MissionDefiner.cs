...
public class MissionDefiner : MonoBehaviour
{
    ...
    public void OnLocationSelected(MissionLocationIcon icon)
    {
        ...
        // PozwÛl potwierdziÊ tylko jeúli typ lokacji na to pozwala (np. dla RouteOnly zawsze true, dla ProceduralRaid tylko jeúli roomCount > 0)
    ...
    // Przeciπøenie do zachowania kompatybilnoúci w innych miejscach w kodzie
    ...
    public void OnConfirmClicked()
    {
        ...
        if (!string.IsNullOrEmpty(pendingLocationName))
        {
            ...
            HideMissionDefinerButtons();
            // NIE czyúcimy summaryCanvas! Zostaje z info do zmiany sceny.
